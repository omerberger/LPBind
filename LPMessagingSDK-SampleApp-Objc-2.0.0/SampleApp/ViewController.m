...
#define DEFAULT_ACCOUNT  @"68573621"
...
- (void)viewDidLoad {
    ...
    NSError *error = nil;
    [[LPMessagingSDK instance] initialize:DEFAULT_ACCOUNT error:&error];
    if (error) {
...
- (void)setUserDetails {
    ...
    [[LPMessagingSDK instance] setUserProfile:user brandID:DEFAULT_ACCOUNT];
}
